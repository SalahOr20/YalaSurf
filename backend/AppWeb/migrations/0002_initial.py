    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('order_type', models.CharField(choices=[('rent', 'Rent'), ('buy', 'Buy')], default='rent', max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surfer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='AppWeb.surfer')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='surflesson',
            name='surf_spot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='AppWeb.surfspot'),
        ),
        migrations.AddField(
            model_name='surfclub',
            name='surf_spot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_type', models.CharField(choices=[('password_reset', 'Password Reset'), ('email_verification', 'Email Verification')], max_length=20)),
